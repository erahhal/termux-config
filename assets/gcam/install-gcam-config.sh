...
PYEOF
    ...
    check_setting 'name="pref_camera_enable_iris">1<'              "IRIS RAW engine on (freeze fixed at HAL, not here)"
    check_setting 'name="pref_camera_kepler_enabled_key">1<'       "Kepler HDR+ RAW engine on"
